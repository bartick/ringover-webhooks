module github.com/ringover/ringover-webhooks/examples/project-webhooks-test-e2e
...
require (
	...
	github.com/ringover/ringover-webhooks v0.0.0-unpublished
)

replace github.com/ringover/ringover-webhooks v0.0.0-unpublished => ../../mods/sdk
